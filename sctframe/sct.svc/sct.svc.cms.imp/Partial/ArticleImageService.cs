...
namespace sct.svc.cms.imp
{
    ...
    public  class ArticleImageService : ArticleImageBaseService,IArticleImageService
    { 

         public PageResult<ArticleImageInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<ArticleImageInfo> result = new PageResult<ArticleImageInfo>();
