...
[DataContract]
  public partial class ArticleVideoInfo
  {
    [DataMember]
    ...
    [DataMember]
    internal int  _ArticleIdIsDirty = 0; 

    [DataMember]
    internal string  _ArticleId; 
    ...
    [DataMember]
    internal int  _FilePathIsDirty = 0; 
    ...
    [DataMember]
    internal int  _FirstImagePathIsDirty = 0; 

    [DataMember]
    internal string  _FirstImagePath; 
