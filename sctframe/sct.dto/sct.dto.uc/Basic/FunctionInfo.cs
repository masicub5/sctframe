...
[DataContract]
  public partial class FunctionInfo
  {
    ...
    [DataMember]
    internal int  _FunctionCodeIsDirty = 0; 

    [DataMember]
    internal string  _FunctionCode; 
    ...
    public string  FunctionCode
    {
      ...
      set{
         _FunctionCode = value;
         _FunctionCodeIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _FunctionNameIsDirty = 0; 
    ...
    public string  FunctionName
    {
      ...
      set{
         _FunctionName = value;
         _FunctionNameIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _FunctionIconIsDirty = 0; 

    [DataMember]
    internal string  _FunctionIcon; 
