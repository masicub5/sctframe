...
[DataContract]
  public partial class FacilityInfo
  {
    ...
    [DataMember]
    internal int  _FacilityCodeIsDirty = 0; 

    [DataMember]
    internal string  _FacilityCode; 
    ...
    public string  FacilityCode
    {
      ...
      set{
         _FacilityCode = value;
         _FacilityCodeIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _FacilityNameIsDirty = 0; 

    [DataMember]
    internal string  _FacilityName; 
    ...
    public string  FacilityName
    {
      ...
      set{
         _FacilityName = value;
         _FacilityNameIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _MenuIdIsDirty = 0; 

    [DataMember]
    internal string  _MenuId; 
