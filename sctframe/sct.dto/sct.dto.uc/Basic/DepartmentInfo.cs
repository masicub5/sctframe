...
[DataContract]
  public partial class DepartmentInfo
  {
    ...
    [DataMember]
    internal int  _DepartmentCodeIsDirty = 0; 

    [DataMember]
    internal string  _DepartmentCode; 
    ...
    public string  DepartmentCode
    {
      ...
      set{
         ...
         _DepartmentCodeIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _DepartmentNameIsDirty = 0; 
